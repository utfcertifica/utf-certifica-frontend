...
import { Avatar, Box, Grid, IconButton, Typography, Accordion, AccordionSummary, AccordionDetails, Button, AccordionGroup, accordionSummaryClasses, accordionDetailsClasses } from "@mui/joy";
  ...
  return (
    <PageWrapper breadcrumbLabel="Visão inicial">
      <Grid container>
        <Grid xs={8}>
          <Box sx={{ pb: "2rem" }}>
            <Typography fontSize={40} fontWeight="600" lineHeight={2} textColor="rgba(38, 42, 65, 1)">
              DASHBOARD
            </Typography>
            <Typography fontSize={16} fontWeight="400" lineHeight={1.5} textColor="rgba(10, 10, 10, 0.5)">
              29 de março de 2024
            </Typography>
          </Box>
          <Box sx={{ pb: "1rem" }}>
            <Typography fontSize={24} fontWeight="600" lineHeight={2} textColor="rgba(38, 42, 65, 1)">
              Próximos Eventos
            </Typography>
          </Box>
          <EventList />
          <Box sx={{ pb: "2rem" }}>
            <Typography fontSize={24} fontWeight="600" lineHeight={5} textColor="rgba(38, 42, 65, 1)">
              Meus Certificados
            </Typography>
          </Box>
        </Grid>
        <Grid xs={4}>
          <Box sx={{ backgroundColor: '#F9FAFC', minHeight: '80vh', padding: '15px', position: 'relative' }}>
            <FAQsAndSupport />
          </Box>
        </Grid>
      </Grid>
...
function EventListItem(props: EventsMock) {
  ...
  return (
    ...
    >
      ...
      <Grid xs={5}>
        <DataLabelDisplay data={props.talkName} label={props.speakersName} />
      </Grid>
      <Grid xs={5}>
        <Typography fontSize={17} fontWeight="400" lineHeight={2.5} textColor="black">
          {props.date}
        </Typography>
      </Grid>
    </Grid>
    ...
    <Box sx={{ p: "1rem", color: "black", textAlign: "center" }}>
      ...
      >
        <Box sx={{ display: 'flex', justifyContent: 'center', gap: '15px' }}>
          <img src={Image1} alt="Image 1" style={{ marginRight: '25px' }} />
          <img src={Image2} alt="Image 2" style={{ marginLeft: '15px' }} />
        </Box>
        <Typography
          fontSize={24}
          fontWeight="400"
